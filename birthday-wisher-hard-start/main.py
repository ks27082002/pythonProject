...
for month,day in dict:
    if month == now.month and day == now.day:
        ...
        with smtplib.SMTP("smtp.gmail.com") as connection:
            ...
            connection.sendmail(from_addr=my_email, to_addrs=dict[(month,day)]["email"], msg="Subject: HAPPY BIRTHDAY\n\n" + text)
